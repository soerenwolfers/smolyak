...
from smolyak import test_series
import pickle
...
if __name__ == '__main__':
    ...
    path=test_series.conduct(name='rsa_kink_d{}'.format(opts['c_dim_par']), tests=tests, func=rsa.run_test, overwrite=True,user_data=opts)
    info,results=test_series.load(path=path)
    os.chdir(path)
